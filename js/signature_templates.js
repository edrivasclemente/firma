...
function get_template_A_str(user_info)
{
  ...
  str += "<table>";
  str +=   "<tr>";
  str +=     "<td style='border-right: 1px solid #000000; padding-right: 5px;'><img src='https://pucmm.edu.do/2021test/Documents/pucmm-api/src/runtime/assets/sample-logo.png' alt='Logo' /></td>";
